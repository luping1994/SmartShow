    ...
    protected BroadcastReceiver broadcastreceiver=new BroadcastReceiver() {
        ...
        public void onReceive (Context context, Intent intent){
            ...
            try {
                ...
                double Powerrate = (Integer.valueOf(Converts.Bytes2HexString(new byte[]{(byte) ((a[51] & 0xff) - 51)})) * 100 + Integer.valueOf(Converts.Bytes2HexString(new byte[]{(byte) ((a[50] & 0xff) - 51)}))) / 1000.0;  //总功率因数
                ...
                data.get(7).put("Value", String.valueOf(IA) + "A");
                data.get(8).put("Value", String.valueOf(IB) + "A");
                data.get(9).put("Value", String.valueOf(IC) + "A");
